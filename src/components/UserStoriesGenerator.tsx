    ...
    const handleDownload = () => {
        ...
        element.innerHTML = `
            <div style="padding: 40px; font-family: sans-serif; color: #333; line-height: 1.6;">
                <h1 style="color: #ef4444; border-bottom: 2px solid #ef4444; padding-bottom: 10px;">User Stories: ${feature}</h1>
        ...
        const opt = {
            margin: 10,
            filename: `UserStories-${feature.substring(0, 30).replace(/[^a-zA-Z0-9]/g, '_')}.pdf`,
